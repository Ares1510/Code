...
class LIDC(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.denoised == True:
            model = SwinIR(img_size=512, patch_size=64, window_size=64, in_chans=1, embed_dim=64, depths=[4], num_heads=[4], mlp_ratio=2, qkv_bias=False, upsampler=None, upscale=1)
